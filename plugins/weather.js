...
if (Config.WORKTYPE == 'private') {
    ...
    Aqua.addCommand({pattern: 'weather ?(.*)', desc: Lang.WEATHER_DESC, fromMe: true, deleteCommand: false}, async (message, match) => {
...
if (Config.WORKTYPE == 'public') {
    ...
    Aqua.addCommand({pattern: 'weather ?(.*)', desc: Lang.WEATHER_DESC, fromMe: false, deleteCommand: false}, async (message, match) => {
    ...
    Aqua.addCommand({pattern: 'weather ?(.*)', desc: Lang.WEATHER_DESC, fromMe: true, dontAddCommandList: true, deleteCommand: false}, async (message, match) => {
