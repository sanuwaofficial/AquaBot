...
Aqua.addCommand({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
...
Aqua.addCommand({on: 'text', fromMe: true, deleteCommand: false}, (async (message, match) => {
...
Aqua.addCommand({pattern: 'afk ?(.*)', fromMe: true, deleteCommand: false, desc: Lang.AFK_DESC}, (async (message, match) => {
    if (!AFK.isAfk) {
